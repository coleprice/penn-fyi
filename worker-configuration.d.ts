/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c5b3ee6dcb9fb73ca4fc79bd2574873b)
// Runtime types generated with workerd@1.20260722.1 2026-07-23 nodejs_compat
interface __BaseEnv_Env {
	TRANSIT_KV: KVNamespace;
	GTFS_ARCHIVE: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	ENVIRONMENT: "production";
	GITHUB_REPOSITORY: "coleprice/penn-fyi";
	FEED_STALE_AFTER_HOURS: "48";
	RECENT_QUERY_WINDOW_DAYS: "14";
	GTFS_RT_TTL_SECONDS: "25";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "GITHUB_REPOSITORY" | "FEED_STALE_AFTER_HOURS" | "RECENT_QUERY_WINDOW_DAYS" | "GTFS_RT_TTL_SECONDS" | "ADMIN_INGEST_TOKEN">> {}
}
